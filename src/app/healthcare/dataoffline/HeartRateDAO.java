...
public class HeartRateDAO extends DbConnectionService {
	...
	public boolean insertSick(HeartRateDTO dto) {
		try {
	...
	public ArrayList<HeartRateDTO> getListSick() {
		ArrayList<HeartRateDTO> arrayListSick = new ArrayList<HeartRateDTO>();
	...
	public HeartRateDTO getSick(String name) {
		HeartRateDTO item = new HeartRateDTO();
