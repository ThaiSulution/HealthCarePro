...
public class HistoryAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		TextView typeFeel = (TextView) vi
				.findViewById(R.id.history_child_item_type_feel);
		...
		ImageView motionStatus = (ImageView) vi
				.findViewById(R.id.history_child_item_type_image);
		...
		typeDate.setText(listHeartRate.get(HistoryHeartRate.KEY_DATE) + " "
				+ listHeartRate.get(HistoryHeartRate.KEY_TIME));
		typeRate.setText(listHeartRate.get(HistoryHeartRate.KEY_RATE));
		imageLoader.DisplayImage(
				listHeartRate.get(HistoryHeartRate.KEY_MOTION_STATUS),
				motionStatus);
		return vi;
	}
}
