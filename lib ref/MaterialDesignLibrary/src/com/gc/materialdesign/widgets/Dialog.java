...
public class Dialog extends android.app.Dialog{
	...
	public Dialog(Context context,String title, String message, int imageId, int contentViewId) {
		...
		if (contentViewId == 0){
			...
			this.contentView = R.layout.dialog;
		}
	...
	@Override
	  protected void onCreate(Bundle savedInstanceState) {
	    ...
	    image = (ImageView) findViewById(contentView);
