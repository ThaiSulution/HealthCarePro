...
function AjaxCall(url, target){
	...
	{
		'url': url
		,'onLoading':function(){ document.getElementById(target).innerHTML="<font class='ajloading'>loading...</font>"; }
		,'onSuccess':function(req){ document.getElementById(target).innerHTML=req.responseText; }
		,'onError':function(req){ document.getElementById(target).innerHTML="<font class='ajloading'>Press F5 to refresh page.</font>"; }
		}
	);
}
